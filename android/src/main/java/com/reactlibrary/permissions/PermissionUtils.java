package com.reactlibrary.permissions;
...
{
    public static @Nullable AlertDialog explainingDialog(@NonNull final RNPhotoEditingLibraryModule module,
    ...
    public interface OnExplainingPermissionCallback {
        void onCancel(WeakReference<RNPhotoEditingLibraryModule> moduleInstance, DialogInterface dialogInterface);
        void onReTry(WeakReference<RNPhotoEditingLibraryModule> moduleInstance, DialogInterface dialogInterface);
    }
}