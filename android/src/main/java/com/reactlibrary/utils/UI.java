...
import com.reactlibrary.RNPhotoEditingLibraryModule;
...
public class UI
{
    public static @NonNull AlertDialog chooseDialog(@Nullable final RNPhotoEditingLibraryModule module,
                                                    ...
                                                    @Nullable final OnAction callback)
    {
        ...
        final WeakReference<RNPhotoEditingLibraryModule> reference = new WeakReference<>(module);
    ...
    {
        void onTakePhoto(@Nullable RNPhotoEditingLibraryModule module);
        void onUseLibrary(@Nullable RNPhotoEditingLibraryModule module);
        void onCancel(@Nullable RNPhotoEditingLibraryModule module);
        void onCustomButton(@Nullable RNPhotoEditingLibraryModule module, String action);
    }
}
